...
public class Activity_modify_income extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        income_money = findViewById(R.id.income_modify_money);
        income_times = findViewById(R.id.income_modify_times);
        income_types = findViewById(R.id.income_modify_types);
        ...
        income_times.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(Activity_modify_income.this, 2, income_times, calendar);
                ;
            }
        });
        ...
        income_types.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(builder_type==null){
                    builder_type = new AlertDialog.Builder(Activity_modify_income.this);
        ...
        public void drawIncome(Income income){
          income_money.setText(String.valueOf(income.getIncomeMoney()));
          income_times.setText(income.getIncomeTime());
          income_types.setText(income.getIncomeTypeName());
        }
        ...
        public void updateIncome(Income i){
            ...
            if(incomeMoney.equals("")||incomeType.equals("")|| incomeTime.equals("")){
                Toast.makeText(Activity_modify_income.this, "请将信息填写完整", Toast.LENGTH_SHORT).show();
            }else {
                ...
                String temp_url = URL.url();
                String url = temp_url+"/income/updateIncome";
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            if(response.code()==200 && toJsonObj.get("code").equals(1)){
                                Looper.prepare();
                                Toast.makeText(Activity_modify_income.this,"修改成功", Toast.LENGTH_SHORT).show();
//                                    Looper.loop();
                                Intent intent = new Intent();
                                intent.setClass(Activity_modify_income.this, MainActivity.class);
                                intent.putExtra("user",user);
                                ...
                                Looper.prepare();
                                Toast.makeText(Activity_modify_income.this, toJsonObj.get("msg").toString(), Toast.LENGTH_SHORT).show();
                                Looper.loop();
                            }else{
                                Looper.prepare();  //后端出错
                                Toast.makeText(Activity_modify_income.this, toJsonObj.get("error").toString(), Toast.LENGTH_SHORT).show();
                                Looper.loop();
                            }
                        } catch (JSONException e) {
                            throw new RuntimeException(e);
